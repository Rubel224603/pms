...
<html lang="en" class="light-style layout-wide  customizer-hide" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ asset('/') }}backend/assets/" data-template="vertical-menu-template" data-style="light">
...
<head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet"
        href="{{ asset('/') }}backend/assets/vendor/libs/%40form-validation/form-validation.css" />
        ...
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner py-6 mx-4">
                ...
                <div class="card p-7">
                    ...
                    <div>
                        <p class ='text-primary text-center'>Continue With</p>
                    </div>
                ...
                <!-- /Login -->
                <img src="{{ asset('/') }}backend/assets/img/illustrations/tree-3.png" alt="auth-tree"
                    class="authentication-image-object-left d-none d-lg-block" />
                <img src="{{ asset('/') }}backend/assets/img/illustrations/auth-basic-mask-light.png"
                    class="authentication-image d-none d-lg-block" height="172" alt="triangle-bg"
                    data-app-light-img="illustrations/auth-basic-mask-light.png"
                    data-app-dark-img="illustrations/auth-basic-mask-dark.png" />
                <img src="{{ asset('/') }}backend/assets/img/illustrations/tree.png" alt="auth-tree"
